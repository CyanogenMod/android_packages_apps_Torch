...
public class FlashDevice {
    ...
    private static boolean useMotoDeathRay = Build.DEVICE.contains("jordan") || Build.DEVICE.contains("sholes") || Build.DEVICE.contains("zepp") || Build.DEVICE.contains("motus");
